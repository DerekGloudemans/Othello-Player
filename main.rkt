...
(define black-strategy-parameter (make-parameter "maximize-difference"))
(define white-strategy-parameter (make-parameter "alpha-beta-searcher-4-weighted-squares"))
